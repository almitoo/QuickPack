package com.example.quickpack.Constants;
...
public class MyConstants {
    ...
    public static final String EVENTS_SCHEDULER_CAMEL_CASE = "events schedule";

    public static final String EXPLORE_LOCATION_CAMEL_CASE = "Explore Location";
